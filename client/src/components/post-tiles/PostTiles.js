        ...
        <div className="tile is-5 is-vertical is-parent">
          <div className="tile is-child">
            <div className="post-buttons">
              <a className="button purple-bg mb-3" href={websiteUrl} target="_blank">
                <i className="fas fa-globe mr-2"></i>
                Visit Live Website
              </a>
              {repoUrl && (
                <a className="button dark-bg mb-3" href={repoUrl} target="_blank" >
              ...
              {user._id === auth.user._id && (
                <button
                  onClick={(e) => dispatch(deletePost(_id, history))}
...
export default withRouter(PostTiles);